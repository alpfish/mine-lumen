...
class FullApplicationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $app = new Application;
        $app->instance('Illuminate\Contracts\Debug\ExceptionHandler', $mock = m::mock('Mine\Exceptions\Handler[report]'));
...
class LumenTestControllerWithMiddleware extends Mine\Routing\Controller
{
    public function __construct(LumenTestService $service)
    {
